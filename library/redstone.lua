...
---@return ccTweaked.redstone.computerSidesTable sides The sides of the computer
------
...
---@param side ccTweaked.peripheral.computerSide The side of the computer to set the state of
...
---@param side ccTweaked.peripheral.computerSide The side of the computer to check
...
---@param side ccTweaked.peripheral.computerSide The side of the computer to set the signal strength for
